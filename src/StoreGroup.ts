...
import { Dispatcher, Store, StoreLike, StoreGroupTypes } from "almin";
import { raq } from "./raq";
...
export class StoreGroup<T> extends Dispatcher implements StoreLike<T> {
    ...
    private _currentChangingStores: Array<Store<T>>;
    private _previousChangingStores: Array<Store<T>>;
    private _stateCache: LRUMapLike<Store<T>, any>;
    private _isAnyOneStoreChanged: boolean;
    private _stores: Array<Store<T>>;
     ...
     * ```
     */
    constructor(stores: Array<Store<T>>) {
        super();
        /**
         ...
         */
        this._stateCache = new LRUMapLike<Store<T>, any>(100);
    }

    /**
     * A collection of stores in the StoreGroup.
     */
    get stores(): Array<Store<T>> {
        return this._stores;
    }
